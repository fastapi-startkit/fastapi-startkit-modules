...
class LogSingleDriver(BaseDriver):
    ...
    def emergency(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "EMERGENCY"
            )
        )
    ...
    def alert(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "ALERT"
            )
        )
        return self.log.critical(message)
    ...
    def critical(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "CRITICAL"
            )
        )
        return self.log.critical(message)
    ...
    def error(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "ERROR"
            )
        )
    ...
    def warning(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "WARNING"
            )
        )
    ...
    def notice(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "NOTICE"
            )
        )
    ...
    def info(self, message, *args, **kwargs):
        self.log.setLevel(logging.INFO)
        self.change_format(
            "{} - {} - %(message)s".format(self.get_time().to_datetime_string(), "INFO")
        )
        return self.log.info(message)
    ...
    def debug(self, message, *args, **kwargs):
        ...
        self.change_format(
            "{} - {} - %(message)s".format(
                self.get_time().to_datetime_string(), "DEBUG"
            )
        )
