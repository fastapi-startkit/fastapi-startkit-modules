...
class Schema:
    ...
    async def has_column(self, table, column, query_only=False):
    ...
    async def get_columns(self, table, dict=True):
        table = self.platform().get_current_schema(await self.new_connection(), table, schema=self.get_schema())
        result = {}
        if dict:
    ...
    async def drop_table(self, table, query_only=False):
    ...
    async def drop_table_if_exists(self, table, exists=False, query_only=False):
    ...
    async def rename(self, table, new_name):
    ...
    async def enable_foreign_key_constraints(self):
    ...
    async def disable_foreign_key_constraints(self):
